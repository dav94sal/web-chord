...
from app.models import Post, db, User#, Vote
...
def posts():
    ...
    posts = Post.query.group_by(Post.id).paginate(page=page, per_page=10).items
    ...
    # posts_paginated = posts.paginate(page=page, per_page=10) # Apply paginate directly to the constructed query
